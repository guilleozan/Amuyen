      ...
      return( 
        ...
        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
          ...
          <div className='botoneEnviar'>
                    {sending ? <p className='btnEnviando'> <Spinner animation="border" />  Enviando...</p> : null}
                    {msg ? <p>{msg}</p> : null}
                    <button className='btn btn-primary descripcionFormulario' type='submit'>Enviar </button>
         </div> 
        </Form>
